    ...
    TEST_CASE("Vector2f")
    {
        SECTION("angleTo")
        {
            SECTION("works for parallel vectors")
            {
                ...
                REQUIRE(a.angleTo(b) == Catch::Approx(0.0f));
            }
            SECTION("works for perpendicular vectors")
            {
                Vector2f a(1.0f, 0.0f);
                Vector2f b(0.0f, 1.0f);
                REQUIRE(a.angleTo(b) == Catch::Approx(Pif / 2.0f));
            }
            ...
            SECTION("works for opposite vectors")
            {
                Vector2f a(0.0f, 1.0f);
                Vector2f b(0.0f, -1.0f);
                REQUIRE(a.angleTo(b) == Catch::Approx(-Pif));
            }
            SECTION("works for vectors not of the same length")
            {
                Vector2f a(0.0f, 1.0f);
                Vector2f b(-1.0f, 1.0f);
                REQUIRE(a.angleTo(b) == Catch::Approx(Pif / 4.0f));
            }
        }
    }
}
