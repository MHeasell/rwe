...
namespace rwe
{
    ...
    UiLabel::UiLabel(int posX, int posY, int sizeX, int sizeY, const std::string& text, const std::shared_ptr<SpriteSeries>& font) : UiComponent(posX, posY, sizeX, sizeY), text(text), font(font)
    {
    }
